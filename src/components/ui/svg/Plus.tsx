...
interface PlusProps extends AllHTMLAttributes<HTMLDivElement> {}
...
const Plus: React.FC<PlusProps> = ({ className }) => {
  return (
    <svg
      ...
      className={`${className} fill-[#005FF8] hover:fill-[#002CFB] group-hover:fill-[#002CFB] cursor-pointer transition duration-150 ease-out`}
    >
